...
When building the project the configuration is available at `tribestream-api-registry-webapp/target/doc/src/configuration.adoc`.
It is also deployed on central: http://repo1.maven.org/maven2/org/tomitribe/tribestream/tribestream-api-registry-webapp/${version}/tribestream-api-registry-webapp-${version}-configuration.adoc
